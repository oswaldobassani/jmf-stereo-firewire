...
public class StereoFireWireCamera {

	static {
		System.loadLibrary ("StereoFireWireCamera");
	}
	...
	public StereoFireWireCamera () {
		System.out.println ("StereoFireWireCamera: constructor");
		//configure();
	}
	...
	public static Format getFormat() {
		System.out.println ("StereoFireWireCamera: getFormat");
		if(format==null){
